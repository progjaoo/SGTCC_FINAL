...
//        {
//            return await _dbContext.ProjetoEntregaProjeto.ToListAsync();
//        }

//        public async Task<ProjetoEntregaProjeto> GetById(int id)
//        {
//            return await _dbContext.ProjetoEntregaProjeto.SingleOrDefaultAsync(x => x.Id == id);
//        }
...
//        {
//            return await _dbContext.ProjetoEntregaProjeto.SingleOrDefaultAsync(up => up.IdProjeto == projetoId && up.IdEntrega == entregaId);
//        }
//    }
//}
